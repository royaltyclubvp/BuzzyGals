...
$dbase          = 'ellefab0.2';       // name of your database
...
$modelsPath = '/Applications/MAMP/htdocs/ef/application/models';
$xpdo_path = '/Applications/MAMP/htdocs/ef/library/Xpdo.php';
include_once ( $xpdo_path );
 
// A few definitions of files/folders:
$package_dir = "$modelsPath/$package_name/";
$model_dir = "$modelsPath/$package_name/model/";
$class_dir = "$modelsPath/$package_name/model/$package_name";
$schema_dir = "$modelsPath/$package_name/model/schema";
$mysql_class_dir = "$modelsPath/$package_name/model/$package_name/mysql";
$xml_schema_file = "$modelsPath/$package_name/model/schema/$package_name.mysql.schema.xml";
