...
--
-- Host: localhost
-- Generation Time: Aug 25, 2012 at 04:12 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Message Storage Table' AUTO_INCREMENT=3 ;
...
(2, 'Jarrod', 'Placide-Raymond', 'jpraymond375', 'male', 'These are interests', '2010-02-10', 'jpraymond375@hotmail.com', 'This is about me', 4, '134431984341.jpeg', 1),
(3, 'Edited Test', 'Account-Name', 'test', 'female', 'Test Interests', '1987-10-22', 'test@email.com', 'About Test', 6, '133660763931.png', 1),
(4, 'Test Second', 'Account', 'test', 'male', 'Test Interests', '1986-06-12', 'test2@email.com', 'About Test', 7, '134431935941.jpeg', 1),
...
CREATE TABLE IF NOT EXISTS `recipient` (
  ...
  KEY `message` (`message`),
  KEY `user` (`user`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Message-Recipient Associations' AUTO_INCREMENT=3 ;
...
(4, 'jpraymond375@email.com', 'd8e44d1027a71884c97ea62fdb896f95bb92224946e5399c085bdac764b74dd1??.0%&-', '2012-05-01 02:58:58', '0000-00-00 00:00:00', 1, '2012-08-13 03:06:29', 1, 1, '', 1),
